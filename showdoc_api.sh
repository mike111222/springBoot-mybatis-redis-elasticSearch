...
#
api_key="788e3e1d3e0c38cd67e1b339798159401760955488" 			#api_key
api_token="bebfe149bc3202280847248c272a4b941671115087" 	#api_token
url="http://localhost:4999/server/index.php?s=/api/open/fromComments" #同步到的url。使用www.showdoc.com.cn的不需要修改，使用私有版的请修改
#
#
#
#
